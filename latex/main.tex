...
\begin{figure}[H]
  \centering
  % Ảnh sẽ được dán vào sau
  \caption[Giao diện cảnh báo môi trường trên Node-RED Dashboard]{Giao diện cảnh báo môi trường trên Node-RED Dashboard}
...
\begin{figure}[H]
  \centering
  % Ảnh sẽ được dán vào sau
  \caption[Sơ đồ nguyên lý phần cứng (EasyEDA)]{Sơ đồ nguyên lý phần cứng (EasyEDA): ESP32, DHT22, BH1750, Potentiometer, Relay, Buzzer}
