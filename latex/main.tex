...
\begin{figure}[H]
  ...
  \caption[Sơ đồ flow xử lý dữ liệu trên Node-RED]{Sơ đồ flow xử lý dữ liệu trên Node-RED}
  \label{fig:flow}
\end{figure}
...
\begin{figure}[H]
  \centering
  % Ảnh sẽ được dán vào sau
  \caption[Dữ liệu log hoạt động và trạng thái kết nối MQTT trên Serial Monitor]{Dữ liệu log hoạt động và trạng thái kết nối MQTT trên Serial Monitor}
