...
\begin{figure}[H]
  \centering
  % Ảnh sẽ được dán vào sau
  \caption[Giao diện tổng quan hiển thị dữ liệu trên Node-RED Dashboard]{Giao diện tổng quan hiển thị dữ liệu trên Node-RED Dashboard}
...
\begin{figure}[H]
  ...
  \caption[Giao diện cảnh báo môi trường trên Node-RED Dashboard]{Giao diện Node-RED Dashboard AgriSense: giám sát đất và tưới, không khí, ánh sáng; nút bật/tắt bơm và tưới tự động; ví dụ toast cảnh báo ánh sáng yếu (\texttt{127.0.0.1:1880/ui})}
...
\begin{figure}[H]
  \centering
  % Ảnh sẽ được dán vào sau
  \caption[Giao diện nút nhấn và công tắc điều khiển máy bơm từ xa]{Giao diện nút nhấn và công tắc điều khiển máy bơm từ xa}
  \label{fig:dieukhien}
\end{figure}
...
\begin{figure}[H]
  ...
  \begin{minipage}{0.45\textwidth}
    \centering
    \includegraphics[width=\linewidth,height=0.18\textheight,keepaspectratio]{images/esp32.png}
    \caption[Vi điều khiển ESP32]{Vi điều khiển ESP32}
    \label{fig:esp32}
  \end{minipage}\hfill
  \begin{minipage}{0.45\textwidth}
    \centering
    \includegraphics[width=\linewidth,height=0.18\textheight,keepaspectratio]{images/dht22.png}
  ...
  \begin{minipage}{0.31\textwidth}
    \centering
    \includegraphics[width=\linewidth,height=0.18\textheight,keepaspectratio]{images/bh1750.png}
    \caption[Cảm biến BH1750]{Cảm biến BH1750}
    \label{fig:hw-bh1750}
  \end{minipage}\hfill
  \begin{minipage}{0.31\textwidth}
    \centering
    \includegraphics[width=\linewidth,height=0.18\textheight,keepaspectratio]{images/potentiometer.png}
    \caption[Biến trở]{Biến trở}
    \label{fig:hw-pot}
  \end{minipage}\hfill
  \begin{minipage}{0.31\textwidth}
    \centering
    \includegraphics[width=\linewidth,height=0.18\textheight,keepaspectratio]{images/relay.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\linewidth,height=0.25\textheight,keepaspectratio]{images/buzzer.png}
