...
\begin{table}[H]
  ...
  \begin{tabular}{|L{4cm}|C{3cm}|C{4.5cm}|}
    ...
    \hline
    Toast cảnh báo đất khô & Hoàn thành & Ngưỡng soilMoisture $<$ 30\%, 8 giây \\
    \hline
    Cảnh báo nguy hiểm (đất rất khô) & Hoàn thành & Ngưỡng soilMoisture $<$ 20\%, hiển thị đỏ \\
    \hline
...
Ch��a triển khai thực tế ngoài mô phỏng Wokwi; chưa dùng cảm biến độ ẩm đất chuyên dụng (dùng potentiometer); \code{setInsecure()} chỉ phù hợp thử nghiệm; chưa lưu lịch sử ngoài biểu đồ Dashboard.
